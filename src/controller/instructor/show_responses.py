...
class HtmlExport(webapp2.RequestHandler):
    def get(self):
        ...
        final = model.Round.get_by_id(3, parent=section.key)
        final_answers, did_not_participate = group_comments(group, section, final)
        template_values['final_seq'] = final_answers
