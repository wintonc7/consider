var commentLength = $('#discussion').data().commentLength;
var response      = $('#discussion').data().response;
var sectionKey    = $('#discussion').data().sectionKey;
var currentPage   = $('#discussion').data().currentPage;
...
function updateAlert(obj, email, type) {
    ...
    message += email + '\'s Round ' + currentPage;
    console.log(message);
    thumbs[email] = type;
}
